...
class OptionsGuiAPI {
    ...
    */
     ...
     * @param folder       Folder of the select
     * @param options      An array containing select options
     * @param defaultValue Default value of the select
     * @param infoText     Small text bubble content describing this parameter
     */
    addSelect(name, folder, options, defaultValue, infoText) {
        // ==== DOM ====
        // Main
        let el = this.createDiv('op-f-el');
        el.appendChild(this.createDiv('op-f-el-t', name));
        let elModule = this.createDiv('op-f-el-select');

        // Select
        let sel = document.createElement('select');
        sel.className = 'op-f-el-s';
